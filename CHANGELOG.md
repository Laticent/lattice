...
- **Anima can now animate a real Lattice chart — with zero model calls.** A new ingest bridge
  ...
  already render" on-ramp (`2026-07-19-anima-svg-first-cut-zdog.md` §0.75). Proven end-to-end on
  the funnel in a real browser; pie / radar / quadrant / map generalize mechanically.
