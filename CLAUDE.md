...
| Adding/changing a surface that SHOWS a slide — it owes keyboard + wheel + touch + zoom, from the kernel | `engineering/decisions/2026-08-10-input-verb-parity.md` + `2026-08-10-preview-pinch-zoom.md` + `lib/core/present-transport.mjs` |
