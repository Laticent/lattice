...
- Refer to the software truthfully: "built with Lattice," "compatible with
  Lattice," "a theme for Lattice."
- Redistribute unmodified copies under the names, with notices intact.
- Use the names in package identifiers that express a dependency or plugin
  relationship (`lattice-theme-foo`), provided the package does not claim or
...
Questions and permission requests: <sharmarke.aden@gmail.com>.
