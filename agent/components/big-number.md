...
- [`stats`](./stats.md) — row of 2-3 metrics, comparable visual weight
- [`kpi`](./kpi.md) — grid of 4-6 metrics with status indicators
- [`split-panel`](./split-panel.md) — the metric needs a paragraph of context alongside it
- [`content`](./content.md) — the argument is mostly prose with a number embedded
