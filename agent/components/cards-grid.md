...
- [`list-steps`](./list-steps.md) — items carry an explicit sequence
- [`cards-stack`](./cards-stack.md) — items stack vertically as full-width rows
- [`compare-prose`](./compare-prose.md) — two-option comparison, side by side
- [`verdict-grid`](./verdict-grid.md) — comparing options against shared criteria
