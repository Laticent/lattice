...
- [`cards-grid`](./cards-grid.md) — three or four parallel items in a scannable grid
- [`compare-prose`](./compare-prose.md) — exactly two items, side by side
- [`list-steps`](./list-steps.md) — items carry an explicit, ordered sequence
