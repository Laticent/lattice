...
- [`compare-prose`](./compare-prose.md) — the change is state, not code
- [`redline`](./redline.md) — the comparison is prose-versus-prose
- [`redline`](./redline.md) — the change is in verbatim text or legal language
- [`table`](./table.md) — three or more variants on shared dimensions
