...
- [`compare-code`](./compare-code.md) — the columns are code, not prose
- [`split-compare`](./split-compare.md) — the verdict needs a bottom recommendation bar
- [`verdict-grid`](./verdict-grid.md) — three or more options scored against shared criteria
- [`decision`](./decision.md) — the verdict slide that lands after a comparison
