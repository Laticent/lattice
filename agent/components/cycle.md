...
- [`list-steps`](./list-steps.md) — the process is linear — a real start and finish, not a loop
- [`timeline-list`](./timeline-list.md) — events fixed to dates rather than a repeating cycle
- [`diagram`](./diagram.md) — the loop has branches or feedback into non-adjacent stages
