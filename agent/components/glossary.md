...
- [`list-tabular`](./list-tabular.md) — rows are key/value reference, not term/definition
- [`divider`](./divider.md) — lighter mid-section orientation — the bright-canvas `light` variant
- [`actors`](./actors.md) — the left column is a named person, not a term
