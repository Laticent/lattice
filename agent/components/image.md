...
- [`diagram`](./diagram.md) — the visual is a Mermaid graph, not a photo or screenshot
- [`content`](./content.md) — the slide is mostly prose with one inline visual
- [`title`](./title.md) — the image is a bookend hero, not the body of a slide
- [`quote`](./quote.md) — the slide is a quotation, not an image
