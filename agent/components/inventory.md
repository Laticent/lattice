...
- [`cards-grid`](./cards-grid.md) — you want a fixed cards grid with nested-bullet authoring
- [`list-steps`](./list-steps.md) — the items carry an explicit sequence
- [`list-tabular`](./list-tabular.md) — more than six rows, or a meta column per row
- [`timeline-list`](./timeline-list.md) — a vertical dated timeline rather than a parallel register
