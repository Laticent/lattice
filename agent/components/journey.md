...
- [`list-steps`](./list-steps.md) — process needs descriptive body per step, no chart
- [`gantt`](./gantt.md) — schedule of overlapping tasks across lanes
- [`kanban`](./kanban.md) — current status by stage rather than sequence over time
