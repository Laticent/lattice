...
- [`gantt`](./gantt.md) — schedule of overlapping tasks across lanes, not current state
- [`roadmap`](./roadmap.md) — phased grid of deliverables across workstreams
- [`checklist`](./checklist.md) — single list of items with done/in-flight/planned states
- [`verdict-grid`](./verdict-grid.md) — options scored against shared criteria, not stage-tracked
