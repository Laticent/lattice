...
- [`cards-stack`](./cards-stack.md) — each item has a title plus body sentence
- [`list-tabular`](./list-tabular.md) — five or more rows with label-plus-description
- [`checklist`](./checklist.md) — items carry state markers (done / partial / todo)
