...
- [`split-compare`](./split-compare.md) — two options weighed before a verdict card
- [`decision`](./decision.md) — naming a chosen path among options already presented
- [`list-criteria`](./list-criteria.md) — a flat enumeration of requirements without a stance or an ask
- [`regulatory-update`](./regulatory-update.md) — a period digest of what changed, not a recommendation on one measure
