...
- [`matrix-2x2`](./matrix-2x2.md) — the 2×2 is categorical, not coordinate-based
- [`radar`](./radar.md) — items rated across more than two criteria
- [`progress`](./progress.md) — percent-complete on a single axis
- [`piechart`](./piechart.md) — part-to-whole, not bivariate position
- [`verdict-grid`](./verdict-grid.md) — comparing options against shared categorical criteria
