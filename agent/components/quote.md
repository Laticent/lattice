...
- [`split-panel`](./split-panel.md) — the quote needs implications spelled out alongside it
- [`content`](./content.md) — the language is paraphrasable — let prose carry it
- [`big-number`](./big-number.md) — the most memorable thing is a metric, not a phrase
