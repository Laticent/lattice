...
- [`compare-code`](./compare-code.md) — the diff is source code, not natural language
- [`compare-prose`](./compare-prose.md) — two narrative alternatives, not verbatim amendments
- [`state-chart`](./state-chart.md) — the change is structural state, not text
- [`obligation-matrix`](./obligation-matrix.md) — comparing many regimes against shared obligations
