...
- [`list-tabular`](./list-tabular.md) — the rows are citation-only references, no obligation prose
- [`obligation-matrix`](./obligation-matrix.md) — obligations cross-tab against actors or controls
- [`authority-chain`](./authority-chain.md) — the rows are a delegation lineage, not parallel jurisdictions
- [`compare-table`](./compare-table.md) — the comparison is across criteria, not jurisdictions
