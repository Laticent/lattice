...
|---|---|---|
| `components.json` | The full machine record for every component: slots, skeletons, variants, capacity, density, when-to-use and anti-patterns. | ~117k |
| `grammar.json` | Which class tokens, variants and modifiers are legal where. What a linter or validator keys off. | ~49k |
| `forms.json` | The Form vocabulary — how a slide is composed (cells, mastheads, stage regions), one level above components. | ~4.6k |
...
| `components.md` | The prose catalog, whole. Almost never what you want — one component file is the same content for one component. | ~129k |
