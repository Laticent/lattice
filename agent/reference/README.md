...
|---|---|---|
| `components.json` | The full machine record for every component: slots, skeletons, variants, capacity, density, when-to-use and anti-patterns. | ~118k |
| `grammar.json` | Which class tokens, variants and modifiers are legal where. What a linter or validator keys off. | ~50k |
...
| `components.md` | The prose catalog, whole. Almost never what you want — one component file is the same content for one component. | ~130k |
