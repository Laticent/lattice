- **Fixed: `engineering/workflow.md` § Merging named a check that does not reproduce.**
  ...
  2026-05-27 under the old SlideWright org: 28 `Merge pull request` commits from PRs
  #2–#30, plus 5 merges of `main` into a feature branch. The command now carries
