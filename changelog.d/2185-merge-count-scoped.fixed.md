- **Fixed: `engineering/workflow.md` § Merging named a check that does not reproduce.**
  ...
  is `0`. Unscoped, it is `33` — all of them pre-queue, between 2026-05-12 and
  2026-05-27 under the old SlideWright org: 28 `Merge pull request` commits (PRs #1–#30
  less #10 and #11), plus 5 merges of `main` into a feature branch. The command now carries
