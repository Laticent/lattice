- **Changed: the portrait gantt band's constants carry their measurement.** The
  ...
  numbers are unchanged; only the reasoning is now checkable. `laneNameH` staying at
  15 while the bar band shrank is recorded as deliberate, with the measurement: the
  lane name's rendered box is 10.8 units, so a 12-unit band would leave about 2px of
