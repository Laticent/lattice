...
- **Tier 1 Universal (51)** — `dark`, `silent`, state markers, tone, insight labels, claim, table toggles (`table-plain`, `table-fill`, `state-cells`, `row-label`, `no-row-label`), `no-note`, `note-warn`, etc.
