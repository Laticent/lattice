...
const REQUIRED = [
	...
	// The desktop-Craft activity rail, and its CONTENT. The band alone is not enough: it shipped
	// as an empty <div> from the day it was added, so a Craft reload drew a blank 52px column
	// beside a top bar rendered control-for-control. The nav marker is what makes "the band
	// exists" and "the band has the rail in it" two different assertions.
