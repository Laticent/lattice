...
export function MotionStage({ art, spec, replayKey, className, reducedMotion }: { art: string; spec: Scene | null; replayKey: string; className?: string; reducedMotion?: boolean }) {
	...
	return (
		<div className={cn('relative', className)}>
			...
			<style>{`
.motion-stage{--motion-shape-play:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M7 4l12 8-12 8z' fill='black'/></svg>");--motion-shape-pause:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M9 5v14M15 5v14' fill='none' stroke='black' stroke-width='3.2' stroke-linecap='round'/></svg>");--motion-shape-replay:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M20 12a8 8 0 1 1-2.34-5.66' fill='none' stroke='black' stroke-width='2.2' stroke-linecap='round'/><path d='M20 3v5h-5' fill='none' stroke='black' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'/></svg>")}
