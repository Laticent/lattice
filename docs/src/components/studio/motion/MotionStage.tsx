...
.motion-stage{--cat-1-mark:var(--accent);--cat-2-mark:color-mix(in oklab,var(--accent) 62%,var(--text-heading));--cat-3-mark:color-mix(in oklab,var(--accent) 45%,var(--text-muted));--cat-4-mark:color-mix(in oklab,var(--accent) 80%,var(--bg));--cat-5-mark:color-mix(in oklab,var(--text-heading) 70%,var(--accent));--cat-6-mark:color-mix(in oklab,var(--text-muted) 60%,var(--accent));--cat-7-mark:color-mix(in oklab,var(--accent) 35%,var(--text-heading));--cat-8-mark:color-mix(in oklab,var(--text-muted) 85%,var(--bg));--cat-9-mark:var(--text-muted);--cat-10-mark:color-mix(in oklab,var(--accent) 55%,var(--border));--cat-11-mark:color-mix(in oklab,var(--text-heading) 50%,var(--border));--cat-12-mark:color-mix(in oklab,var(--accent) 25%,var(--text-muted));--motion-shape-play:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M7 4l12 8-12 8z' fill='black'/></svg>");--motion-shape-pause:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M9 5v14M15 5v14' fill='none' stroke='black' stroke-width='3.2' stroke-linecap='round'/></svg>");--motion-shape-replay:url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M20 12a8 8 0 1 1-2.34-5.66' fill='none' stroke='black' stroke-width='2.2' stroke-linecap='round'/><path d='M20 3v5h-5' fill='none' stroke='black' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'/></svg>")}
