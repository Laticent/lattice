...
This page mirrors the in-repo design doc [`design/concepts.md`](https://github.com/Laticent/lattice/blob/main/design/concepts.md), which owns the model. It joins the [four-axis model](https://github.com/Laticent/lattice/blob/main/design/design-system.md) and the [Form composition model](https://github.com/Laticent/lattice/blob/main/design/forms.md) — the two docs that own the axes and the structural nouns respectively.
:::
