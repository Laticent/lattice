...
[`dist/docs/grammar.json`](https://github.com/Laticent/lattice/blob/main/dist/docs/grammar.json), generated from the
component manifests.
...
published in [`dist/docs/grammar.json`](https://github.com/Laticent/lattice/blob/main/dist/docs/grammar.json)). The
canonical shape is:
...
own its schema. [`dist/docs/grammar.json`](https://github.com/Laticent/lattice/blob/main/dist/docs/grammar.json) records
...
- **Modifiers** — recognized by set membership or by these prefix families:
  ...
  [`lib/authoring/lint-core.js`](https://github.com/Laticent/lattice/blob/main/lib/authoring/lint-core.js); the enumerated
  variant tiers are cataloged in
  [`design/design-system.md`](https://github.com/Laticent/lattice/blob/main/design/design-system.md) §6.5.
...
- **L1 (structure).** A fixture pairs an LFM document with the components and
  ...
  [`dist/docs/grammar.json`](https://github.com/Laticent/lattice/blob/main/dist/docs/grammar.json) is the oracle.
