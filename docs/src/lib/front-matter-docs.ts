...
export const FRONT_MATTER_DOCS: Record<string, FrontMatterDoc> = {
	...
	stamp: { group: 'accent', default: 'tab', studio: 'Accent → More → Stamp shape', slide: '_class: stamp-<value>' },
	tone: { group: 'accent', default: 'rail', studio: 'Accent → More → Tone shape', slide: '_class: tone-<value>' },
