...
var require_math_block_rule = __commonJS({
  "lib/core/math-block-rule.js"(exports, module) {
...
${text}`;
    ...
    function installMathBlockRule(md2) {
      md2.block.ruler.before("fence", "math_block", mathBlockRule);
    }
...
var require_boundary_parser = __commonJS({
  "lib/core/boundary-parser.js"(exports, module) {
    ...
    var { installMathBlockRule } = require_math_block_rule();
    function createBoundaryParser() {
      const md2 = new MarkdownIt("commonmark", { html: true, breaks: true });
      md2.enable(["table", "strikethrough"]);
      installMathBlockRule(md2);
      return md2;
    }
    var boundaryParser = createBoundaryParser();
    var FRONT_MATTER = /^---(?:\r\n|\r|\n)[\s\S]*?(?:\r\n|\r|\n)---(?:\r\n|\r|\n)?/;
    function normalizeSource2(text) {
      return typeof text === "string" ? text.replace(/^﻿/, "").replace(/\r\n?/g, "\n") : "";
    }
    module.exports = { createBoundaryParser, boundaryParser, FRONT_MATTER, normalizeSource: normalizeSource2 };
  }
});
...
function normalizeSourceText(text) {
  return (0, import_boundary_parser.normalizeSource)(typeof text === "string" ? text : "");
}
...
function slideBoundaries(body) {
  ...
  const tokens = [];
  import_boundary_parser.boundaryParser.block.parse(text, import_boundary_parser.boundaryParser, {}, tokens);
  const lines = [];
...
var import_boundary_parser, memoKey, memoValue;
var init_slide_boundaries = __esm({
  "lib/core/slide-boundaries.mjs"() {
    import_boundary_parser = __toESM(require_boundary_parser(), 1);
    memoKey = null;
    memoValue = null;
  }
});
...
var require_slide_split = __commonJS({
  "lib/authoring/slide-split.js"(exports, module) {
    ...
    function separatorLines(lines) {
      ...
      let seps = slideBoundaries2(body).lines;
