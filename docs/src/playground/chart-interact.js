...
export function createChartInteract({ stage, getFrame, lift = true, onReveal, onDetail, hoverAny = false }) {
  ...
  const CHART_SVG_SEL = '.bar-svg, .bullet-svg, .line-svg, .scatter-svg, .slope-svg, .stacked-bar-svg, .waterfall-svg, .piechart-svg, .funnel-svg, .map-svg, .quadrant-svg, .radar-svg, .heatmap-svg, .state-chart-figure, .state-chart-edges, .flowchart-svg, .gantt-svg';
