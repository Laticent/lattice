...
import {
  ...
  readCachingEnabled,
  readSpend,
} from '../components/studio/ai/spend.js';
import { getPref, PREFS, setPref } from './drawing-board-prefs.js';

// The pure spend/budget/preference kernel moved to the Studio in the P1
// code-ownership flip (2026-07-03-studio-succession.md §3). Re-exported here so
// the frozen Drawing Board modules keep their one historical import path until
// they are deleted with this surface.
export {
  budgetStatus,
  readBudgetCap,
  readBudgetFloor,
