...
// The spend/budget/preference kernel moved into the Studio when it took ownership of
// the AI cluster (2026-07-03-studio-succession.md §3). This frozen panel is the last
// DOM consumer and dies with the route; the arrow deliberately points at the successor.
import {
  BUDGET_CAP_KEY,
  BUDGET_FLOOR_KEY,
  BUDGET_MODE_KEY,
