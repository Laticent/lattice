...
| `tools/check-jank.js` | check-jank — does a component's layout STAY PUT as its content grows? Anchor DRIFT, silent COLLISION and CROWDING, measured over a rendered content sweep. |
...
| `tools/build-agent-kit.mjs` | build-agent-kit — assemble dist/agent-kit/, the kit an LLM or coding agent |
