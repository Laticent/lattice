...
natively. And yet **664 tracked files mention Marp**: 3,118 prose/code lines
...
| `history` | 111 | 1,282 | 3 | **KEEP FROZEN** — dated records |
...
## §4 — `history` (111 files, 1,282 lines): frozen
