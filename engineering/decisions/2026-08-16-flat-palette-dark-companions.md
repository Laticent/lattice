...
**It does not, on its own, unblock #1527.** It closes the flat-over-pair class, which is
the one the ticket enumerated; measuring it surfaced two more blockers of a different
shape (§ Logged, not fixed), and those are not structurally detectable the way this class
was. Read this note as "one prerequisite of at least three", not as the all-clear.
