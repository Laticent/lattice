...
- [Blurred `box-shadow` → opaque gray box around the element in some PDF viewers](gotchas/export.md#blurred-box-shadow--opaque-gray-box-around-the-element-in-some-pdf-viewers)
- [A blurred `box-shadow` renders as a flat gray block in Apple PDFKit](gotchas/export.md#a-blurred-box-shadow-renders-as-a-flat-gray-block-in-apple-pdfkit)
