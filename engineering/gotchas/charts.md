...
- **Not this:** The Studio's own in-app **Reading view** (`ReadArticle.tsx`) shows the same black charts for a different reason: it ships no deck stylesheet at all, because it renders in the app's top-level document. Tracked in `followups.d/`.
