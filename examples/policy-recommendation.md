...
theme: indaco
paginate: true
header: "Digital Governance Caucus · Session brief"
---

<!-- _class: title silent -->

# The session's four calls.

`Digital Governance Caucus · 2026 session`

Four measures reach the floor this week — here is where the caucus should stand on each, and the exact move to make.
...
> Vote NO on AB 402, or strike the § 5 escrow mandate in committee.
...
## Two ayes, one no, one to study — the caucus speaks with one voice.

`Rep. Ana Okafor · Chair · governance@statehouse.example`
