...
# Every split reads the same way
...
- Scoring model
  - Recalibrated on eighteen months of outcomes, then frozen.
- Decision log
  - Every call has a written owner, a date, and its evidence.
- Calibration loop
  - Weekly review closes the predicted-to-actual gap.
- Partner onboarding
