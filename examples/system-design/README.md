...
`examples/system-design-foundations.md` is one deck: 232 slides, 233
...
| 8 | [The Scale Kit](ch08-the-scale-kit.md) | Part four | 12 | 16 |
...
**Slides** counts what came from the omnibus — 230 of its 232, the two it
...
acronym registry still defines something. 291 pages in all.
