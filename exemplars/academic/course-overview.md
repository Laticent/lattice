...
theme: indaco
paginate: true
header: "Computational neuroscience · Course overview"
---
...
2. The twelve-week arc
3. What you will be able to do by the end
4. Logistics, grading, and what to do this week
...
| Module | Weeks 1–4 `Single neuron` | Weeks 5–8 `Populations` | Weeks 9–12 `Learning` |
| --- | --- | --- | --- |
| Theory | [x] Membrane & cable | [-] Network dynamics | [ ] Synaptic plasticity |
| Coding labs | [x] Integrate-and-fire | [-] Recurrent networks | [ ] Learning rules |
| Readings | [x] Hodgkin–Huxley | [-] Attractor models | [ ] Predictive coding |
...
4. Read the literature critically
...
- [x] Enroll and join the course forum.
...
## By December, you will have built a brain that learns — line by line.
