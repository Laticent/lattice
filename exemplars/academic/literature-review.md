...
theme: indaco
paginate: true
header: "Urban heat islands · Literature review"
---
...
1. `1974` Heat island documented
   - Early studies establish that cities are measurably hotter than rural surroundings.
2. `1990` Albedo era `live`
   - Research pivots to reflective roofs and pavements as the first engineered fix.
3. `2005` Green infrastructure
   - Urban trees and green roofs reframed as multi-benefit cooling.
4. `2018` Equity turn `decision`
   - Studies show heat burden falls hardest on low-income neighbourhoods.
5. `2024` Whole-system models `at-risk`
   - Coupled climate-energy models question whether single fixes scale citywide.
...
## We know what cools a building — we still don't know what cools a city fairly.

`Candidate · Tomás Herrera · Environmental Studies · comprehensive exam`
