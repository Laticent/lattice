...
theme: indaco
paginate: true
header: "Microbiome recovery · Thesis defense"
---
...
We followed 200 adults prescribed a standard amoxicillin-clavulanate course. Stool was collected at baseline, day 7, day 30, and months 3, 6, and 12. Shotgun metagenomics gave species-resolution community profiles at every timepoint.
...
2. 32%
   - incomplete at 12 mo
3. 3.4×
   - recovery odds with keystone present
4. p<0.001
...
| Track | Now `2026` | Next `2027` | Later `2028` |
| --- | --- | --- | --- |
| Prediction | [x] Keystone biomarker | [-] Clinical assay prototype | [ ] Point-of-care test |
| Intervention | [x] In-vitro restoration | [-] Pre-treatment supplementation trial | [ ] Randomised clinical trial |
| Mechanism | [x] Butyrate cross-feeding map | [-] Strain-level resolution | [ ] Causal gnotobiotic models |
...
## A fragile gut is one missing its keystone — and we can see it before the first dose.
