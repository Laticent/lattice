 ...
 * filter ONLY when the subject really is a descendant of a stamped section. A
 * Read · Article figure (`figure.foo`) is NOT: it is re-hosted outside every slide, so
 * `:where([data-family="tall"]) figure.foo .bar` matched nothing either. 37 such arms
 * were removed on 2026-09-25 (followups.d/2344-p3); the figure lays out by the article
 * column's own width, not by the slide's shape.
