...
function isKnownModifier(token, vocab) {
  ...
  // A mode name is a legal per-slide class — the register is the source of truth, so
  // adding a mode never needs a second edit here.
  if (MODE_NAMES.includes(token)) return true;
