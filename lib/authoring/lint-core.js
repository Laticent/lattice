...
/**
 * Front-matter `spectrum-card:` register validation — the opt-in spectrum rail on card
 * surfaces (on / off). Warns on an unrecognized value, which silently renders the OFF default.
 * Canonical list injected (lib/core/resolve-spectrum.js `SPECTRUM_CARD_NAMES`), keeping this
 * core require-free.
 */
