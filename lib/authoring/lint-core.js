...
function liveTrackDirective(slide) {
  ...
  for (let i = 0; i < lines.length; i += 1) {
    ...
    if (COMMENT_LINE.test(line)) {
      ...
      // failure this rule exists to report — and the committed fuzz measures the
      // cost of getting this wrong as +84 silences on one-directive slides
      // (582 -> 666), which is a number the suite re-derives. An earlier comment
      // here quoted 720 / +38% from a scratch cross nothing in the tree runs.
