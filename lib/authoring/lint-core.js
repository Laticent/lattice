...
function findBadRenderTargetValues(source) {
  ...
  for (const key of RENDER_TARGET_KEY_NAMES) {
    ...
    // The raw line, for the report — matched the same way the KERNEL matches it, case
    // included. This drifted once and the drift was user-visible: the kernel started reading
