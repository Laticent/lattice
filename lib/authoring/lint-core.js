        ...
        for (const t of tokens) {
          if (excluded.includes(t)) {
            findings.push({
              ...
              classToken: t,
              line: m[0],
              message: `'${t}' runs '${comp}' to the true edge, where its content is cropped`,
              fix: `Use 'claim-hero' instead (keeps a hairline safe zone), or move the content into a media/canvas layout that can bleed.`,
            });
          }
        }
      }
