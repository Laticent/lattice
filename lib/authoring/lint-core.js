    ...
    for (const t of tokens) {
      ...
      if (renamedTo) {
        ...
        findings.push({
          ...
          fix: `Replace '${t}' with '${renamedTo}' in this slide's class. There is no alias — the old name renders as a plain \`content\` slide, which keeps the table styled but drops its row capacity, autosplit, portrait card reshape and focus axes.`,
        });
        continue;
      }
