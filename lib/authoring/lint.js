...
// isn't flagged as an unknown class. `chart-anima` animates a rendered chart in place
// on the live surfaces (§0.75, docs/src/lib/chart-anima-hydrate.ts); a no-op on a
// non-chart section, so it's safe everywhere.
const ANIMATION_MODIFIERS = ['chart-anima'];
