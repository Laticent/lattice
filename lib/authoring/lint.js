...
const { SPECTRUM_EDGE_NAMES, SPECTRUM_EDGE_TOKENS, SPECTRUM_CARD_NAMES, SPECTRUM_CARD_TOKENS } = require('../core/resolve-spectrum');
...
function buildVocab(manifests) {
  ...
  const universalModifiers = new Set([...BASE_MODIFIERS, ...FRAME_MODIFIERS, ...SEMI_UNIVERSAL_VARIANTS, ...STAMP_STYLE_TOKENS, ...TONE_STYLE_TOKENS, ...SPECTRUM_TOKENS, ...SPECTRUM_EDGE_TOKENS, ...SPECTRUM_CARD_TOKENS, ...RULE_TOKENS, ...EYEBROW_TOKENS, ...LIFT_TOKENS]);
