...
function buildVocab(manifests) {
  ...
  const universalModifiers = new Set([...BASE_MODIFIERS, ...FRAME_MODIFIERS, ...SEMI_UNIVERSAL_VARIANTS, ...STAMP_STYLE_TOKENS, ...TONE_STYLE_TOKENS, ...SPECTRUM_TOKENS, ...LIFT_TOKENS]);
