...
function buildVocab(manifests) {
  ...
  return { names, modifiers, universalModifiers, capacity, claimExcludes, mapRegions: buildMapVocab(), finishNames: [...FINISH_NAMES], modeNames: [...MODE_NAMES], splitNames: [...SPLIT_NAMES], universalGroups, semiUniversalVariants: [...SEMI_UNIVERSAL_VARIANTS], exclusiveAxes };
}
