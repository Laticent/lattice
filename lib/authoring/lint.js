...
function buildVocab(manifests) {
  ...
  const universalModifiers = new Set([...BASE_MODIFIERS, ...FRAME_MODIFIERS, ...SEMI_UNIVERSAL_VARIANTS, ...STAMP_STYLE_TOKENS, ...TONE_STYLE_TOKENS]);
  ...
  return { names, modifiers, universalModifiers, capacity, claimExcludes, mapRegions: buildMapVocab(), finishNames: [...FINISH_NAMES], modeNames: [...MODE_NAMES], splitNames: [...SPLIT_NAMES], claimNames: [...CLAIM_NAMES], universalGroups, semiUniversalVariants: [...SEMI_UNIVERSAL_VARIANTS], exclusiveAxes, stampStyles, toneStyles: [...TONE_STYLE_TOKENS], stampStyleNames: [...STAMP_STYLE_NAMES], toneStyleNames: [...TONE_STYLE_NAMES] };
}
