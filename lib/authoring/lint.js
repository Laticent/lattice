...
const { CARDS_NAMES, CARDS_TOKENS } = require('../core/resolve-cards');
const { CORNERS_NAMES, CORNERS_TOKENS } = require('../core/resolve-corners');
...
const { INLINE_CODE_NAMES, INLINE_CODE_TOKENS } = require('../core/resolve-inline-code');
