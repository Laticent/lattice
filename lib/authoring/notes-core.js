 ...
 * guess. Both callers take the candidates from `NOTE_SCRUB_BOUNDARIES` below rather than
 ...
 */
// The candidate cuts, IN THE ORDER THEY ARE TRIED — the one piece of this measurement both
// export paths must agree on, so it lives here rather than in each of them. `preserve` first is
...
// least. Adding a candidate, or reordering these, changes both paths at once — which is the
...
const NOTE_SCRUB_BOUNDARIES = Object.freeze(['preserve', 'drop']);
