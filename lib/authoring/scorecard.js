 ...
 * the weights. `craftProse` is thinnest everywhere (1.5%-8.7%) against a 32.4% nominal
 * weight; by the same reasoning that is not evidence it is dead, and it is the next
 * weight to be suspicious of.
 *
