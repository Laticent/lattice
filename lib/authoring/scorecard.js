 ...
 *     and Contract is pinned to 100 on the corpus BY CONSTRUCTION — measured: 0
 *     findings across all 198 scorable committed decks, and the gate's own sweep (277
 ...
 * Decomposed over prefix-truncations of the whole corpus as a draft proxy, Contract
 * carries 27.8%-74.4% of Craft's variance depending on the truncation model; 38.2%
 * sits inside that band, so the weight is defensible and cutting it would have been
 * wrong — but the honest statement is "not zero, and this corpus cannot price it."
 *
