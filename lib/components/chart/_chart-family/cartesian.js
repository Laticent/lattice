 ...
 * @param {boolean} [o.markFor] stamp `data-mark-for="i"` on label i, making it a tap
 *                             proxy for mark i in the reveal layer. Only for a chart whose
 *                             mark i IS category i (waterfall); a chart whose marks are per
 *                             series or per segment must not opt in.
 */
