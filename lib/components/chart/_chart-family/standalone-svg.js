 ...
 * grammar check, not an injection guard.
 *
...
function applyCollectedTokens(el) {
  ...
  // Always strip, even when nothing was admitted: it is scratch space between the two
  // halves of one export, and a clone that keeps it publishes the deck's resolved
  // palette into whatever the caller does with the element next.
