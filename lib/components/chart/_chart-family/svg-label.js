...
const GLYPH_UPPER = {
  clean: {
    ...
    // The WIDE punctuation, mapped explicitly because it is wider than any
    // letter and so cannot ride the fallback below (see there). The em-quad
    // dashes are exactly what their names say — a flat 2em and 3em.
