...
const GANTT_GEOM_TALL = {
  ...
  // property of THIS STAGE, not of these constants. Give p9 a three-line heading and
  // the stage collapses 690.8 -> 416.7px while the chart is unchanged, overflowing by
  // 205px. The band reserves a row on the fixture's stage; nothing here can promise
  // one on every stage, and an earlier draft of this comment read as if it did.
  rowGap: 5,
  lanePadY: 7,
