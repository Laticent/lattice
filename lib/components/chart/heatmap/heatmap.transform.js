 ...
 * 3 to 12. Discrete stops step over it. Measured on the shipped set: 4 of 75
 * stops need a nudge, none by more than 2%, every palette solves, the ramp stays
 * monotonic, and the worst pair is 4.65:1 with a median of 7.44:1.
 *
...
function buildHeatmap(model, ctx = {}) {
  ...
  // A cell too small for the number keeps the intensity and drops the text —
  // `cellFitsValue` below carries the geometry. Contrast is no longer the
  // question it once was; room still is.
