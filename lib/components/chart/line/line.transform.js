...
function buildLine(model, ctx = {}, opts = {}) {
  ...
  if (variant === 'stacked-area') {
    ...
    model.rows.forEach((row, s) => {
      ...
      marks.push(`<path class="line-path line-edge" data-hue="${s + 1}" data-series="${s}" data-anima-role="line"`
    ...
    model.rows.forEach((row, s) => {
      ...
      segs.forEach((idxs) => {
        ...
        marks.push(`<path class="line-path" data-hue="${s + 1}" data-series="${s}" data-anima-role="line"`
