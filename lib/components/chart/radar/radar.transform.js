...
const MINI_VIEWBOX = `${-MINI_LABEL_PAD} 0 ${DIAGRAM_W + 2 * MINI_LABEL_PAD} ${DIAGRAM_H}`;
...
// Shared wrapping <text> emitter — rim labels wrap instead of running off the
// viewBox. See svg-label.js.
const { wrapSvgLabel, ADVANCE_UPPER } = require('../_chart-family/svg-label');
...
const {
  escHtml, stripTags, plainText, fmtNum, findOuterUL, splitTopLevelLI,
