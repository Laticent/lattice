...
// A cell's rendered HTML as the plain words it shows, for an attribute: the family's fixed-point
// tag strip and entity decode (`lib/core/plain-text.js`), whitespace folded. The result is text,
// and every caller re-escapes it with `_escAttr` before it lands in an attribute.
