 ...
 * prepending a 63.7 KB IIFE to the serialised pass (lattice-emulator.js). That
 ...
 * dagre's answer is only ever USED on a machine that BRANCHES. Zero of the 13
 * machines in the shipped galleries branch, so every one of them paid 63.7 KB
 * raw / 22.4 KB gzipped for a layout that was discarded.
 *
 ...
 * 22.4 KB gzipped, invisible. A false NEGATIVE silently drops a branching
