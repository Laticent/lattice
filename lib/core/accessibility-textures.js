...
const CAT_FILLS_DARK = [
  '#1e1e1e', '#252525', '#2c2c2c', '#333333', '#3b3b3b', '#434343',
  '#4b4b4b', '#535353', '#5c5c5c', '#646464', '#6d6d6d', '#757575',
];
...
const CONCRETE_FILLS_LIGHT = [
  '#FDFBFB', '#F6F9F7', '#F3F4F5', '#F0EFEE', '#ECEAEB', '#E5E7E7',
  '#E2E2E0', '#DCDEDC', '#DADADC', '#D7D5D7', '#D1D2D0', '#CECDCF',
];
...
module.exports = {
  ...
  MIRRORED_RAMPS: { CAT_FILLS, CHART_FILLS, CAT_FILLS_DARK, CONCRETE_FILLS_LIGHT, CONCRETE_FILLS_DARK },
};
