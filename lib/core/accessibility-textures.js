...
// BESPOKE raw-concrete motifs for the `concrete` theme — the categorical texture
// vocabulary drawn from cast concrete + formwork rather than generic hatching, so
// the pattern reads as "themed" to the brand. Same 8×8 tile, same stroke/fill
...
function texturePatternDefs() {
  ...
  // concrete: same scheme-flip, but BESPOKE raw-concrete motifs and concrete's own
