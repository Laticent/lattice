...
//
// TWELVE, and the number is now a READABILITY call rather than a width one. It was 4 for one
// commit, set when the band still carried the deck's running footer: four marks shared one
