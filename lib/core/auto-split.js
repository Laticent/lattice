...
// `resplitDoc` wants a splittable axis and the authored pacing. Mirrors lint-core's
...
// MEASURED pass — the ONLY pass. Given `overflow` (the slides a real render found to clip, each
...
module.exports = {
  authoredIndexPerPage, resplitDoc, capacityForClass, layoutTokenFor, repaginate, applyRails, applyRelationshipSignals };
