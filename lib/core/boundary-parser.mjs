...
import { guardHtmlInline } from './html-inline-guard.mjs';
...
export function createBoundaryParser() {
  ...
  // Three callers run the FULL `md.parse` (section-source-split, bake-splits, slide-class-spans —
  // the first on the CLI's narration export), so inline rules do run here. See html-inline-guard.mjs.
  guardHtmlInline(md);
