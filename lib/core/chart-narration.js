...
function narrateWordCloud(markdown) {
  ...
  //
  // MEASURED ON THE SHIPPED CORPUS, not argued: render every deck in the tree with a
  // word-cloud slide and compare `data-count` against the slide's top-level bullets,
  // and 2 of 34 slides draw fewer than they list — both of them
