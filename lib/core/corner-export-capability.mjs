 ...
 * slide frame (lib/core/slide-frame.mjs) traces the slide's outline with an edge and a
 * shadow, so the corner reads even on the deck's own `--bg`. (It used to be invisible there,
