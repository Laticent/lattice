 ...
 *
 * BOTH reads are TOP-LEVEL, the same column-0 rule `CLASS_LINE` below explains and
 * the export writer applies. Reading either key loosely here while writing it
 * strictly there is not a stylistic difference — it makes the render path and the
 * exported bytes disagree about which line is the register.
 */
