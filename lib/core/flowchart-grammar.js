...
function outlineFromMarkdown(md) {
  ...
  for (const raw of lines) {
    ...
    if (li) {
      ...
      inList = true;
      const item = { segs: inlineSegments(li[4]), children: [], quotes: [], line: trimmed };
...
module.exports = {
  ...
  readArrow, splitRow, parseSpan, parseFlowchart, outlineFromMarkdown, inlineSegments, slug, tidy,
};
