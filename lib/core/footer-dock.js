 ...
 * footer text, the SECTION rail (`nav.tile-progress`, lib/forms/tile/progress) the split
 * k-of-N rail (`nav.lat-split-rail`, lib/core/auto-split.js `applyRails`) and the page number.
...
module.exports = { dockInFooterCell };
