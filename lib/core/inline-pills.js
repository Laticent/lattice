 ...
 * (examples/, lib/, docs/src, test/integration — 12,493 spans). Repo-wide it is 31, all in
 * engineering prose that never renders — `{children}`, `{staged_files}`, `{ok:true}`. An
 * earlier draft of this line said "repo-wide" of a number measured on 11% of the tree,
 * which is the claim-names-its-surface failure HARD RULE #23 exists to stop.
