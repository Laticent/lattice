 ...
 * @param {object} [deck.readAlong]       read-along section: voice config + optional
 *                                        per-slide measured CaptionTrack / audio
 *                                        (2026-07-08-read-along-export-manifest.md).
 *                                        Passed through verbatim — the caller (which
 *                                        has Cadenza) builds it; the kernel only carries it.
 * @param {object} [opts]
