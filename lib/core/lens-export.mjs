...
/** A rendered `<section …>` OPEN TAG. `\sclass="` — the leading space is the #1358 guard. */
export const isHoleOpenTag = (openTag) => /\sclass="[^"]*\blens-hole\b/.test(String(openTag ?? ''));
/** A whole rendered section, as a string. Same predicate; the open tag is inside it. */
export const isHoleSectionHtml = (html) => isHoleOpenTag(html);
