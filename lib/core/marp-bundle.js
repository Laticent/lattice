...
quietly: an overflowing slide gets a ring and a small **"More below"** tab.
...
|---|---|
| \`reader\` | a small "More below ↓" pill along the bottom edge — the export default |
...
The marker never changes the layout — it is drawn over the slide. Trimming the
content, or moving it to a layout with more room, is the actual fix.
