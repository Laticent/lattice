 ...
 *
 * Reasons: `derivation`, `theorem` and `stats` are already single-column, so a tall
 * box needs nothing collapsed. `canvas` places its body with `grid-template-areas` on
 * the SECTION.
 *
