...
const MERMAID_VAR_MAP = {
  ...
  //                                 The token already existed and is already gated
  //                                 >=4.5:1 against every --cat-N-mark; nothing was
  //                                 pointing at it.
  ...
  // own <style> (indaco light: #2E608A / now #FFFFFF, 6.5:1). On a Lattice SLIDE
  ...
  // The baked pair still matters wherever our CSS does not ride along — an SVG
  // lifted out of the deck, PPTX export — which is the whole premise of
