 ...
 *                                    across the token-contrast decks, at exactly
 *                                    2px, with no ink outside any box
 *   (2, 3]                  2
 *   (3, 12]                 34     ← REAL, and silent (18 of them cut:true)
 *
 * 28 of those slides, across 21 decks, are ones `probeContentClipped` calls a cut
 * at zero tolerance, and 27 are BODY content rather than caption-footer chrome:
 ...
 * assertions, and it adds ~30 slides to the `overflow:check` ratchet that nobody has
 ...
 *
 * Measured consequence, stated rather than implied: of the 28 slides the truthful probe
 * calls a silent cut, this advisory names 18. Ten stay silent, nine of them body
 * content, and they are listed by name in the decision note. Lowering the floor would
 * not reach them either — eight sit at excess 0.
 *
