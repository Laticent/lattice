...
//     false ring §4c exists to prevent.
...
const IGNORED_CLIP_SELECTOR = '.split-feat-bleed, .watermark, .katex-mathml, [aria-hidden="true"], .overflow-tab, .illegible-tab, .lattice-fixme-tab, .lattice-fixme-box, .lattice-fixme-overlay';
