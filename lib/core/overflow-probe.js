 ...
 *   ─────────────────────   ───────────────────────────────────
 *   0                       3931   ← nothing to say
 *   (0, 2]                  26     ← phantom: 14 of them are ONE split-panel
 *                                    slide across the token-contrast decks, at
 *                                    exactly 2px, and probeContentClipped answers
 *                                    cut:false on every slide in this band
 *   (2, 3]                  2
 ...
 *
 * Taken from the distribution above, not from taste: below 2px is rounding, and the
 * (0, 2] band is dominated by a single slide shape that `probeContentClipped`
 * clears at zero tolerance. Above 3 the measured ink outside the clip box tracks the
 * number (excess 4 -> 4.02px of a `<strong>` outside its box, 6 -> 5.58, 11 ->
 * 10.64). So 3 is where a number stops being noise and starts being a cut.
 *
