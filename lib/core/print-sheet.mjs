...
export function buildPrintCss(gw, gh, opts) {
	...
	return (
		...
		'.lattice{visibility:visible!important;height:auto!important;overflow:visible!important;filter:none!important;' +
		...
		`zoom:${zoom};box-shadow:none!important;outline:none!important;` +
