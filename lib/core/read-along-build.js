 ...
 * @property {ReadonlyMap<string,string>} [symbols] deck glyph overrides (`symbols:`); author beats the built-in commons
...
function buildReadAlong(slideTexts, opts) {
	...
	const symbols = opts.symbols; // deck glyph overrides (`symbols:`); author beats the built-in commons
