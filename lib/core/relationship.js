 ...
 * rather than in the input squared: 422ms → under a millisecond on that shape, flat from 4,000 to
 * 32,000 repeats. (A previous revision of this line said 0.003ms. Re-measured warm, best of 200
 * after 50 warm-up iterations, it is 0.54ms — the SHAPE claim holds and the number was 180x off,
 * on a branch whose subject is numbers nobody re-derives.)
 *
