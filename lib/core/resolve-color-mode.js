 ...
 */
/**
 * The deck's front-matter block (`---` … `---`, delimiters included), or ''.
 *
 ...
 * lib/core/diagram-band.js — is scoped by the same regex. Two halves of the band
 ...
 * separator mid-document is not front matter. Accepts a block that has already
