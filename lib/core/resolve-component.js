...
/** A slide whose body is split into two component panes (lib/core/panes.js HOST_CLASS).
 *  It names no component of its own, and must not fall back to `content`, whose
 *  descendant rules would reach into both panes. */
const PANES_HOST = 'lat-pane-host';
