 ...
 *   fade     how long the spark takes to come and go, in ms.
...
export const DELIVERY_PRESETS = Object.freeze({
  restrained: Object.freeze({ budget: 2, floor: 1, ink: 'none', spark: 'accent', pulse: true, fade: 320, hold: 'none', caption: 'crawl', strength: 'quiet', motion: 'legible' }),
  expressive: Object.freeze({ budget: 4, floor: 0, ink: 'top', spark: 'accent', pulse: true, fade: 240, hold: 'none', caption: 'crawl', strength: 'notable', motion: 'full' }),
  somber: Object.freeze({ budget: 1, floor: 1, ink: 'none', spark: 'muted', pulse: false, fade: 900, hold: 'aside', caption: 'still', strength: 'quiet', motion: 'legible' }),
});
 ...
 * @returns {{ name: string, budget: number, floor: number, ink: 'none'|'top', spark: 'accent'|'muted', pulse: boolean, fade: number, hold: 'none'|'aside', caption: 'crawl'|'still', strength: 'quiet'|'notable', motion: 'full'|'legible' }}
 */
