 ...
 * deck moves a pixel. `left`/`center`/`right` pin the whole framing cluster as one system
 * by overriding the shared `--headline-align` seam (see lib/base/base.accent-finish.css).
 *
 ...
 *   headline: center → head-center  center the framing cluster
 *   headline: right  → head-right   right-align the framing cluster (the rare escape)
 *
...
// other three each carry a `head-<value>` class.
