 ...
 * The engine builds `header:` / `footer:` chrome at core ruler step 14, and the deck class
 * is propagated at step 25 — eleven steps later — so at the moment chrome is rendered the
