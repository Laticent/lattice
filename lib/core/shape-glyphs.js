...
const SHAPE_GLYPHS = Object.freeze([
  ...
  },
  {
    ...
    token: '--mark-x',
    authorFix: 'Write the state marker `[!]` (no / not met / rejected) — the engine draws the ' +
      'red cross disc. In a table cell, add `state-cells` to the slide.',
  },
  {
  ...
  },
  {
    ...
    token: null,
    authorFix: 'Write `[ ]` — the engine draws the hollow open ring, which is the "not ' +
      'started" reading this glyph is reaching for.',
  },
  {
    glyph: '❓', name: 'BLACK QUESTION MARK ORNAMENT', role: 'status',
    token: '--mark-question',
    authorFix: 'Write `[?]` (unknown) — the engine draws a hollow ring with a drawn question ' +
      'mark. This one is an EMOJI: full color, palette-blind.',
  },
  {
    glyph: '❔', name: 'WHITE QUESTION MARK ORNAMENT', role: 'status',
    token: '--mark-question',
    authorFix: 'Write `[?]` (unknown) — a drawn question mark in a hollow ring. This one is an EMOJI.',
  },
  {
  ...
  },
  {
    ...
    token: null,
    authorFix: 'Say what is pending in words, or mark it `[-]` (partial) / `[?]` (unknown) / `[ ]` (not started). Emoji-presented.',
  },
  {
  ...
  // ── discs, rings and geometry — bullets and swatches
  {
    ...
    token: null,
    authorFix: 'A bullet is what a `-` list already gives you. For a STATUS dot, write one of ' +
      'the six state markers (`[x]` `[-]` `[!]` `[?]` `[ ]` `[/]`) and let the state disc carry ' +
      'both shape and color.',
  },
  {
    glyph: '○', name: 'WHITE CIRCLE', role: 'bullet',
    token: null,
    authorFix: 'Write `[ ]` — the engine draws a true hollow open ring in every layout, and ' +
      'it takes the status color.',
  },
  {
