...
const TREATMENTS = Object.freeze({
  ...
  // decline to split: it produced a SIX-PAGE run in which every body page carried the whole
  // five-stage board, identical, with the section band labels colliding with the rows
