...
const TREATMENTS = Object.freeze({
  ...
  // Connected / related → 1/slide + a relationship signal (§0b). NOT yet atomized:
  // §0b is explicit that atomizing these WITHOUT the →next / ↻loop / compare-N-of-M
  // adornment is what makes atomization unreadable, so they keep packing to budget
  // until the signal ships (rule 12a, unbuilt).
