...
const TREATMENTS = Object.freeze({
  ...
  //
  // It sits in the `comparison` bucket beside compare-table and split-compare, and it is
  ...
  // and the strategy is `cover-paginate` rather than compare-table's `cover-cards`:
  ...
  //
  // It is compare-table's shape — a wide read-across grid — and it gets compare-table's reader,
  // `cover-cards`, for compare-table's reason: a wide table cannot paginate out of HORIZONTAL
...
const TREATMENT_NOTES = Object.freeze({
  ...
  'obligation-matrix': "compare-table's shape and compare-table's reader — the grid reshapes to one regime card per page at portrait, and renders natively at landscape",
