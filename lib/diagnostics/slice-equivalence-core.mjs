...
function dividerDerivation(deck) {
	...
	const flags = callerChunks(blankCode(stripFm)).map(dividerTokens);
	...
	const ambiguous = callerChunks(stripFm).filter(dividerTokens).length !== total;
	sectionDerivation = { deck, flags, total, ambiguous };
