 ...
 * harness that RECONSTRUCTS what the Studio's slice route hands the engine; it never
 * drove `docs/src/lib/single-slide-render.ts` or the real Studio. Under HARD RULE #23
 * that is an estimate of that surface, not a measurement of it, and it is recorded as
 * one rather than quoted as fact.
 *
