 ...
 * that key. Measured on `math.gallery.md`: 2.47ms -> 1.19ms per keystroke on one
 * slide, 26.6ms -> 16.7ms on the whole-deck route.
 *
 ...
 * inline-heavy prose. Measured over every committed deck containing math (11 of
 * them), the worst is `math.gallery.md` at 94KB across 58 distinct expressions,
