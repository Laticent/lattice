...
function slideIsInlineCodeLiteral(token, src) {
  ...
  // runs ELEVEN rules after this one (`lattice_header_footer` is 14th, `deck_class_propagate`
  // 25th), and re-appending the deck-wide token to a slide that carries its own `_class:` is
