...
// `lib/theme/chain.mjs` (`replaceThemeNameImports`), shared with the only other
// caller that must read the edge out of content — `flattenCssImports`, for the
// caller-supplied `--css` sheet. This file used to carry its own regex, and the two
// had already drifted: the bare `@import concrete;` form resolved there and MISSED
// here. One grammar, one place, so the next fix cannot reach one copy and not the
// other. See engineering/decisions/2026-08-17-composition-stays-content-addressed.md.
