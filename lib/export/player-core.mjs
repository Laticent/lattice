...
// `.light` carve-out, and a bright divider quietly takes on-dark inks over its own white
// canvas. `test/unit/export/html-player.test.js` pins the grammar so the next entry cannot
// introduce that silently.
