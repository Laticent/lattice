...
#lp-article p{margin:0 0 1em}#lp-article ul,#lp-article ol{margin:0 0 1.1em;padding-left:1.3em}#lp-article li{margin:.3em 0}#lp-article .lp-roster{list-style:none;padding-left:0}#lp-article .lp-roster li{display:flex;align-items:baseline;gap:.6em}#lp-article .lp-roster img{flex:none;width:1.9em;height:1.9em;border-radius:50%;object-fit:cover;align-self:center}
