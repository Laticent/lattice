 ...
 * non-default `size:` (4K, story, portrait, square, mobile — 35 of the committed ones)
...
export async function assemblePlayer(data, caps) {
	...
	// The deck's REAL canvas, handed in by the host. A host that omits it gets the historical
	// 1280x720, so a default-size deck is byte-identical to before this existed — which the
	// frozen-artifact golden enforces, and which is why the fallback is a default rather than a
	// throw. Both shipping hosts do pass it; the fallback exists for fixtures and third parties.
	const canvas = {
