...
#lp-article .lp-roster{list-style:none;padding-left:0}#lp-article .lp-roster>li{display:flex;align-items:baseline;gap:.6em}#lp-article .lp-roster>li>img{flex:none;width:1.9em;height:1.9em;border-radius:50%;object-fit:cover;align-self:center}
