...
export async function playerJs(animaJs = '', beats = null, captions = !!beats, canvas = PLAYER_CANVAS, chart = null) {
	...
	const capKernel = captions ? `var makeCursor=${(await import('@laticent/cadenza')).makeCursor.toString()};\n` : '';
	const kernel =
		capKernel +
