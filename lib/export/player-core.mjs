...
// its own message that the player "mirrors it whole". It did not, and a `color-mode: light`
// deck with a divider still rendered on-light ink on a permanently dark panel after a toggle
// to dark — 1.61:1, the same number and the same panel as the defect that commit closed.
// Mirroring two thirds of a predicate is how this keeps coming back.
//
