...
/* The roster: a portrait beside the person's line. EVERY combinator here is a CHILD
   combinator, and that is load-bearing rather than tidy — a roster row re-emits the
   author's own note markup verbatim, so a DESCENDANT form turned a nested list under
   a person into flex items: markers gone, the sub-list floated beside the sentence
   instead of indented under it. The img rule squashed an inline image in a note into
   a 34px circle the same way. Reachable from plain, lint-clean markdown (a third-level
   bullet under a person), so the scope IS the fix.
   (No backticks in this comment: the stylesheet is a template literal.) */
#lp-article .lp-roster{list-style:none;padding-left:0}#lp-article .lp-roster>li{display:flex;align-items:baseline;gap:.6em}#lp-article .lp-roster>li>img{flex:none;width:1.9em;height:1.9em;border-radius:50%;object-fit:cover;align-self:center}#lp-article .lp-roster>li>div{flex:1;min-width:0}#lp-article .lp-roster>li>div>:is(ul,ol){margin:.3em 0 0}
