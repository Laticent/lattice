...
#lp-article .lp-video-link{display:inline-flex;align-items:center;gap:.75em;max-width:100%;padding:.65em 1.1em .65em .65em;border:1px solid var(--border,#ddd);border-radius:12px;background:var(--bg-alt,#f7f7f7);color:var(--text-heading,#111);font-weight:600;text-decoration:none}
