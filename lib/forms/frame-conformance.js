...
function hasClass(html, cls) {
  // A class attribute whose value contains `cls` as a whitespace-delimited token:
  // class="cls", class="a cls", class="cls b", or class="a cls b".
