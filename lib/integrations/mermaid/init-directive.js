 ...
 */
function engineInitConfig(themeVars, { look } = {}) {
  return {
    theme: 'base',
...
const DIVERGENT_CONFIG = Object.freeze([
  ...
  // A deliberate preview behavior, and the one sanction here that is a CHOICE rather
  // than a Mermaid constraint. `false` renders a flowchart at intrinsic size instead of
  // stretching it to the container, so sizing stays consistent across a deck.
  //
