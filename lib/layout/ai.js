...
const ASK_SYSTEM =
  ...
  'material tint = `color-mix(in srgb, var(--cat-3-mark) 12-22%, var(--bg))`, neutrals = `var(--text-body)`/`var(--text-muted)`/`var(--border)`.\n' +
...
const REPAIR_SYSTEM =
  ...
  '`var(--text-secondary)`/`var(--text-muted)`/`var(--border)`. Categorical hues are `var(--cat-1-mark) … var(--cat-12-mark)`.\n' +
