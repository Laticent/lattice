...
module.exports = {
  ASK_SYSTEM, REPAIR_SYSTEM, REFINE_DESIGN_SYSTEM, COMPONENT_CANON,
  askComponentMessages, askRepairMessages, askDesignRefineMessages, coerceRefinement,
  coerceComponent, rankSimilar, auditComponentDesign, addScopePrefix, slugifyName,
  fixCardNesting, MAX_CSS_BYTES,
};
