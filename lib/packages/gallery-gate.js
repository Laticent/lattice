...
const { remoteRefsInElements, mermaidRemoteRefs, isRemoteUrl, galleryRefusal } = require('../core/remote-ref.js');
...
function galleryRemoteRefs(source) {
  ...
  return [...new Set([...remoteRefsInElements(elements(parse5.parse(html, { scriptingEnabled: false }))), ...defined, ...fenced])];
}
