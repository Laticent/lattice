 ...
 *   · pt is the unit an author already thinks in for type, and the unit this
 *     engine documents its own roles in (lib/typography/scale.js: `meta` is
 *     11.25pt, `body` 16pt). "5pt" is instantly placeable against those.
 *
 ...
 * where it is one hover away and sits next to the fix. The label is 20 characters
 * against the old 24.
 *
