...
(() => {
  ...
  function applyDeckClassFromFrontMatter() {
    ...
    fetch(mdUrl)
      ...
      .then((src) => {
        ...
        const deckTokens = [...classTokens, ...finishTokens, ...modeTokens, ...claimTokens, ...stampTokens, ...toneStyleTokens, ...spectrumTokens];
  ...
  function startOverflowWatcher() {
    ...
    // lattice-emulator.js's embedded export watcher had, #894/#896). Every
    ...
    if (typeof document.fonts !== 'undefined') {
      try {
        Promise.all(Array.prototype.map.call(document.fonts, (f) => f.load().catch(() => {})))
