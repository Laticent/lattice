...
const { spectrumClass } = require('../../lib/core/resolve-spectrum');
...
(() => {
  ...
  function applyDeckClassFromFrontMatter() {
    ...
    fetch(mdUrl)
      ...
      .then((src) => {
        ...
        // Deck-wide SPECTRUM register — the white-label brand-bar control (resolve-spectrum.js).
        ...
        const deckTokens = [...classTokens, ...colorModeTokens, ...finishTokens, ...modeTokens, ...claimTokens, ...stampTokens, ...toneStyleTokens, ...spectrumTokens, ...liftTokens];
  ...
  function applyCachedDeckClass() {
    ...
    for (const section of document.querySelectorAll('section')) {
      ...
      const slideHasOwnSpectrum = cur.some((c) => c.startsWith('spectrum-'));
      ...
      for (const t of deckTokens) {
        ...
        if (slideHasOwnSpectrum && t.startsWith('spectrum-')) continue;
