...
(() => {
  ...
  // a second copy of that map — 132 keys against the PDF path's 166, a strict
  // subset, kept in sync by a comment that pointed at the other file. The gap was
  // invisible because nothing compared them; test/unit/core/diagram-theme-parity
  // .test.js now does, and fails on any divergence outside DIVERGENT_KEYS.
