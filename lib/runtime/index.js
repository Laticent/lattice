...
const { fluidDefaultFills, overflowTabText, overflowTabAction } = require('./fluid-view-policy');
...
(() => {
  ...
  function initFluidView() {
    ...
    if (wants("fixed")) apply(false);
      ...
      // Boundary + rationale live in the tested fluid-view-policy kernel.
      apply(fluidDefaultFills(window.innerWidth, window.innerHeight));
    }
  }
