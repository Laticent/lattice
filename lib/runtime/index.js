...
const { measureTrim, planTrim, applyTrim, clearTrim, clearTrimBoxes } = require('../../lib/core/guards-trim');
        ...
        if (guardsEnabled(s.className)) {
          ...
          if (trimModel.boxes.length) {
            ...
            if (plan.actions.length) {
              ...
              const stillOver = measureTrim(s, CLIP_CELL_SELECTOR, TOL, trimNs).boxes.map((b) => b.id);
