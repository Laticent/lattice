...
function transformInlinePills() {
  ...
  function bootstrap() {
    ...
    // Arm the deadline above. 3s is far past any real sibling-`.md` fetch and far short of
    // "the reader gave up"; it fires only if the promise never settles, so the ordinary
