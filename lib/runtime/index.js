...
function transformInlinePills() {
  ...
  function bootstrap() {
     ...
     *
     * `OWN_SCRIPT` makes the question exact: the parser reached our element, so everything
     * before it that the parser owned has run. Three narrowings, each falling back to the
     ...
     * script at all. Driven, at `/mermaid-demo/`, against a `/plain-demo/` control.
     */
