  ...
  function applyDeckClassFromFrontMatter() {
    ...
    fetch(mdUrl)
      ...
      .then((src) => {
        ...
        const deckTokens = [...classTokens, ...colorModeTokens, ...finishTokens, ...modeTokens, ...claimTokens, ...stampTokens, ...toneStyleTokens, ...spectrumTokens, ...spectrumEdgeTokens, ...spectrumCardTokens, ...ruleTokens, ...eyebrowTokens, ...liftTokens];
  ...
  function applyCachedDeckClass() {
    ...
    for (const section of document.querySelectorAll('section')) {
      ...
      for (const t of deckTokens) {
        ...
        if (slideHasOwnSpectrumCard && t === 'spectrum-card') continue;
