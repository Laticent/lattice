 ...
 *                  best-effort ink plus an audit that reports it. Degradations
 *                  are collected in `degraded[]` for the caller to surface.
 *
 ...
 * design already accepts. `checkCatContrast`'s collapse arm holds the floor that
 * matters.
 */
