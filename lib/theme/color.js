/**
 * Pure, dependency-free color math — the SINGLE SOURCE of the color
...
/**
 * OKLCH → `#aabbcc`, reducing chroma toward 0 (binary search) until the color
 * fits the sRGB gamut. Lightness and hue are preserved; only chroma gives way —
 * the standard gamut-clip that keeps a color recognizable.
 */
...
/**
 * Perceptual distance (ΔE) between two hex colors in OKLab — the Euclidean
...
/**
 * Perceptual mix of two hex colors in OKLab. `t` is the weight of `hexB`
