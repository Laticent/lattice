 ...
 * assertions in test/unit/palette/contrast.test.js one-for-one, PLUS the
...
function contractPairs() {
  ...
  // renderer was the mermaid parse-error box, which now uses the gated ['bg','fail']
  // error-chip pair instead — so --cat-on-mark no longer needs to clear
