/**
 * Color-vision-deficiency (CVD) simulation — pure, dependency-free.
 *
 * Given a color, return what a viewer with a given dichromacy would perceive.
 * This is the measurement primitive the color-blindness accessibility work is
 ...
 * gate must assert against. The matrices' rows sum to 1, so achromatic colors
 ...
 *   - lib/theme/color.js                  (the color primitives reused here)
...
/**
 * Simulate how `hex` appears under color-vision deficiency `type`
...
/**
 * Perceptual distance between two colors *as seen under* deficiency `type` —
 ...
 * the same color under a deficiency score near 0 here.
 */
