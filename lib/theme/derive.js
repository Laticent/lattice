...
function deriveTheme(essentials, options = {}) {
  ...
  const mutedTextLight = solveInk(e.textMuted, e.bg, e.bgAlt)
    ?? bestEffortInk(e.textMuted, e.bg, e.bgAlt);
  const mutedTextDark = solveInk(darkMuted, darkBgDeeper, darkBgAlt)
    ?? bestEffortInk(darkMuted, darkBgDeeper, darkBgAlt);
