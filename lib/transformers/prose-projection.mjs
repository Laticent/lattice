...
const MEDIA_COMPONENTS = new Set([
	'bar', 'bullet', 'line', 'scatter', 'slope', 'stacked-bar', 'waterfall',
...
const CHART_TOKEN_COMPONENTS = new Set(['bar', 'bullet', 'line', 'scatter', 'slope', 'stacked-bar', 'waterfall', 'funnel', 'map', 'piechart', 'quadrant', 'radar']);
