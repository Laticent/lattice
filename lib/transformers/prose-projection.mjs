...
const WORD_MAPS = {
	...
	// list-tabular's register is COMPLETION, like checklist: a ledger row's `[x]` is
	// "done". Its disc carries the word on `aria-label`, not as text, so reading the
	// class here adds it once rather than doubling it (lib/core/list-tabular-marks.js).
	'list-tabular': { pass: 'done', warn: 'partial', skip: 'skipped', todo: 'to do', fail: 'not done' },
};
