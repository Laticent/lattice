...
/** The full authored class token list (component + variants) — the F-B key. */
 ...
 *  "wireframes"), and a nested list is coordinated (all leaves) or recursed. */
...
export function projectDeckToSpeech(sections) {
	return sections.map((section) => {
		...
		else if (MEDIA_COMPONENTS.has(component)) body = speakGeneric(stage, eyebrow); // prose caption only; visual skipped
