...
const TRANSFORMERS = [
  ...
  // them. Every rebuilder below scans the section's children; they step over
  // frame cells (`isFrameCell`), so the beats are out of reach by the time they
  // run. See lib/core/coda.js and
