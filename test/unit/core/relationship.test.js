...
describe('core: relationship — textOf reads typeset math as rendered symbols', () => {
  ...
  // The LINEAR-time guard for this scan moved to the on-demand perf tier:
  // test/benchmark/relationship-scaling.test.js (`npm run test:perf`). It asserts a
  // scaling RATIO, and a wall-clock arm in a parallel blocking suite is a flake
  // generator — see that file's header for the measurement.
