...
describe('deckContextKey', () => {
	...
	test('the encoding is injective — no separator an author can type splits it', () => {
		// Length-prefixed, not joined on a delimiter. A slide whose text contains whatever
		// delimiter we picked would otherwise let two different decks build one key.
