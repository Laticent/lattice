...
// The genre table + resolver. The Studio Coach needs it directly (not only through
// reviewCore) so the panel can SHOW which profile is in play, where that came from,
// and offer the override — an inferred profile must be a visible guess, never a
// silent one. See lib/authoring/deck-profiles.js.
...
const BUILD_OPTIONS = {
  ...
  legalComments: 'none',
  banner: {
    js: '/* Auto-generated by tools/build-authoring-core.js — DO NOT EDIT.\n   Source: lib/authoring/{lint-core,review-core,scorecard,notes-core,deck-profiles}.js. Rebuild: npm run authoring-core:build */',
  },
};
