...
const SCRIPT_META = {
  ...
  'equiv':                    ['Test & verify', 'Slice/deck equivalence sweep — for every slide of every committed deck, does rendering it ALONE (behind a synthesized directive prelude) match rendering it inside the deck? The headless half of the preview-fidelity diagnostic; the author-facing half is the Studio\'s "Preview fidelity" overlay. On-demand, not a CI gate.'],
  ...
  'equiv:check':              ['Test & verify', 'Re-run `equiv` and compare vs the committed baseline; fails on a drop beyond 1.5 points. On-demand, not a blocking CI gate.'],
