...
const SCRIPT_META = {
  ...
  'equiv:check':              ['Test & verify', 'Re-run `equiv` and compare vs the committed baseline: decks/slides/preludes/positions must match exactly, and the rate may drift 1.5 points. Verified able to fail by mutation: stubbing `positionIsTrustworthy` to `return false` takes it 91.9% -> 10.4%, and stubbing `deckSectionFor` to `undefined` takes it to 67.5%.'],
