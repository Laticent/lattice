...
const SCRIPT_META = {
  ...
  'chapters:system-design':   ['Build & bundle', 'Cut examples/system-design-foundations.md into the thirteen standalone chapter decks under examples/system-design/ (wrapper slides, per-chapter acronym registry, index). The omnibus stays the single source of every slide body; build:check fails on a stale chapter.'],
