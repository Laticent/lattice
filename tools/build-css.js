...
function main(argv) {
  ...
  // Pass the assembled base bundle so each theme's chart-colour fallback resolves
  // against it (it stands in for the theme's `@import 'lattice'`).
  const themes = buildThemes(fresh);
