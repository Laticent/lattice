 ...
 * Chromium.
 *
 * Freshness: docs/scripts/preset-thumbs-sources.json records a sha256 of the preset table
 * (lib/core/front-matter-key.js `PRESETS`) plus the sample slide. The unit test
...
const { presetThumbHash, PRESET_THUMB_SAMPLE } = require(path.join(ROOT, 'tools/lib/preset-thumbs.cjs'));
