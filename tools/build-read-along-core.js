 ...
 *     (chart-narration require('@laticent/cadenza') — the built workspace package)
 ...
 * resolves the whole graph (including the `require('@laticent/cadenza')` →
...
// bundler resolves `require('@laticent/cadenza')` through the workspace
