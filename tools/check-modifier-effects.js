...
async function main() {
  ...
  if (bless) {
    const doc = {
      $comment: 'Generated by tools/check-modifier-effects.js --bless — do not edit by hand. Per component: `surfaces` — the probed surfaces on which at least one `_class:` modifier measurably changes the render of its sample; `inert` — content surfaces the sample has but no modifier changed; `variants` — surfaces a declared variant adds. tools/build-docs-portal.js publishes these to the editor. See engineering/decisions/2026-09-24-positional-class-completion.md.',
      probed: PROBED,
      components: sorted,
    };
