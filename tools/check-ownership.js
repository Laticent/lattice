...
const SANCTIONED_PREVIEW_BUILDERS = [
  ...
  { file: 'docs/src/components/studio/present/presenter-window.js', why: 'buildStageDoc — the shared dual-screen presenter AND rehearsal stage (drawing-board-practice delegates here, P3b).' },
